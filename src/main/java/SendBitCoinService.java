...
public class SendBitCoinService {
    ...
    private static final String RECEIVER_ADDRESS = "tb1ql7w62elx9ucw4pj5lgw4l028hmuw80sndtntxt";
    private static final String WALLET_FILE_PREFIX = "bitcoinj-test";
    ...
    public static void main(String[] args) throws Exception {
        ...
        WalletAppKit kit = new WalletAppKit(params, new File("."), WALLET_FILE_PREFIX);
        kit.startAsync();
        kit.awaitRunning();
        ...
        Coin value = Coin.parseCoin("0.000005");

        // To which address you want to send the coins?
        // The Address class represents a Bitcoin address.
        SegwitAddress to = SegwitAddress.fromBech32(params, RECEIVER_ADDRESS);
        ...
        try {
            Transaction tnx = new Transaction(params);
            tnx.addInput(kit.wallet().getUnspents().get(0));
            tnx.addOutput(value, to);
            SendRequest request = SendRequest.forTx(tnx);
...
//            System.out.println("**********");
//            System.out.println(kit.wallet().getUnspents());
